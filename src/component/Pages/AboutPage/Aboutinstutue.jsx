      ...
      <div className="container py-3 pt-4">
        <div className="row justify-content-center g-3 g-md-4">
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card h-100 border shadow-lg text-center p-3">
              <div className="mb-2">
                <FontAwesomeIcon
                  icon={faGem}
                  size="2x"
              ...
              <h4 className="mb-2" style={{ fontFamily: "Roboto Slab, serif" }}>
                Our Value
              </h4>
              <p
                style={{ fontFamily: "Poppins, sans-serif", fontSize: "15px" }}
              >
                The Union of Science and Spirituality alone will bring Peace to
                Mankind.
              </p>
            </div>
          </div>
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <div className="card h-100 border shadow-lg text-center p-3">
              ...
              >
                ...
                <br />
                With Effective, Sustainable, Inclusive, and Progressive
                Transformation that impacts society.
              </p>
            </div>
          </div>
            ...
            <div className="card h-100 border shadow-lg text-center p-3">
              ...
              <ul className="list-unstyled small text-start">
                ...
                <li className="mb-1">
                  ...
                  We-Culture of empathy and compassion, reflected in our focus
                  on improving the current state of affairs
                </li>
                <li>
                  {" "}
                  <span
