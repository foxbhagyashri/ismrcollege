...
const Testimonials = () => {
    ...
    const testimonials = [
      {
        ...
        role: "Adma’s student",
        img: "./usericon.png",
        text: "Universities value student who can think critically & solve problems. Reviewer may assess student ability analyze information, evaluate different perspectives.",
        rating: 5,
      },
      {
        id: 2,
    ...
    const settings = {
      ...
      slidesToShow: 3,
      slidesToScroll: 1,
      arrows: false, // we'll make our own arrows
      pauseOnHover: true,
      responsive: [
        {
          breakpoint: 992,
    ...
    return (
      <section className="testimonials-section py-5">
        <Container>
          <h2 className="section-title text-center mb-5">What Student’s Say</h2>
